import { g as getDefaultExportFromCjs, s as se$1, n as ne$1, T as T$3, a as a$3, y as y$2, p as p$2, o as oe$1, t as te$1, R as R$2 } from "./index-DjBwCyIP.js";
/**
 * @license
 ...
 */
var t$3;
const i$3 = window, s$2 = i$3.trustedTypes, e$4 = s$2 ? s$2.createPolicy("lit-html", { createHTML: (t2) => t2 }) : void 0, o$3 = "$lit$", n$4 = `lit$${(Math.random() + "").slice(9)}$`, l$3 = "?" + n$4, h$2 = `<${l$3}>`, r$1 = document, u$1 = () => r$1.createComment(""), d$1 = (t2) => null === t2 || "object" != typeof t2 && "function" != typeof t2, c$2 = Array.isArray, v$2 = (t2) => c$2(t2) || "function" == typeof (null == t2 ? void 0 : t2[Symbol.iterator]), a$1 = "[ 	\n\f\r]", f$1 = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, _$2 = /-->/g, m$1 = />/g, p$1 = RegExp(`>|${a$1}(?:([^\\s"'>=/]+)(${a$1}*=${a$1}*(?:[^ 	
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const t = globalThis, i2 = t.trustedTypes, s2 = i2 ? i2.createPolicy("lit-html", { createHTML: (t2) => t2 }) : void 0, e = "$lit$", h$1 = `lit$${Math.random().toFixed(9).slice(2)}$`, o2 = "?" + h$1, n = `<${o2}>`, r = document, l$1 = () => r.createComment(""), c$1 = (t2) => null === t2 || "object" != typeof t2 && "function" != typeof t2, a = Array.isArray, u2 = (t2) => a(t2) || "function" == typeof (t2 == null ? void 0 : t2[Symbol.iterator]), d = "[ 	\n\f\r]", f = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, v$1 = /-->/g, _$1 = />/g, m = RegExp(`>|${d}(?:([^\\s"'>=/]+)(${d}*=${d}*(?:[^ 	
...
const P = (t2, i3) => {
  ...
  for (let i4 = 0; i4 < s3; i4++) {
    const s4 = t2[i4];
    let a2, u3, d2 = -1, y2 = 0;
    for (; y2 < s4.length && (c2.lastIndex = y2, u3 = c2.exec(s4), null !== u3); ) y2 = c2.lastIndex, c2 === f ? "!--" === u3[1] ? c2 = v$1 : void 0 !== u3[1] ? c2 = _$1 : void 0 !== u3[2] ? ($.test(u3[2]) && (r2 = RegExp("</" + u3[2], "g")), c2 = m) : void 0 !== u3[3] && (c2 = m) : c2 === m ? ">" === u3[0] ? (c2 = r2 ?? f, d2 = -1) : void 0 === u3[1] ? d2 = -2 : (d2 = c2.lastIndex - u3[2].length, a2 = u3[1], c2 = void 0 === u3[3] ? m : '"' === u3[3] ? g : p) : c2 === g || c2 === p ? c2 = m : c2 === v$1 || c2 === _$1 ? c2 = f : (c2 = m, r2 = void 0);
...
function N2(t2, i3, s3 = t2, e2) {
  var _a, _b;
  if (i3 === w) return i3;
  let h2 = void 0 !== e2 ? (_a = s3._$Co) == null ? void 0 : _a[e2] : s3._$Cl;
  const o3 = c$1(i3) ? void 0 : i3._$litDirective$;
  return (h2 == null ? void 0 : h2.constructor) !== o3 && ((_b = h2 == null ? void 0 : h2._$AO) == null ? void 0 : _b.call(h2, false), void 0 === o3 ? h2 = void 0 : (h2 = new o3(t2), h2._$AT(t2, s3, e2)), void 0 !== e2 ? (s3._$Co ?? (s3._$Co = []))[e2] = h2 : s3._$Cl = h2), void 0 !== h2 && (i3 = N2(t2, h2._$AS(t2, i3.values), h2, e2)), i3;
}
let S$1 = class S {
  constructor(t2, i3) {
    this._$AV = [], this._$AN = void 0, this._$AD = t2, this._$AM = i3;
  ...
  u(t2) {
    const { el: { content: i3 }, parts: s3 } = this._$AD, e2 = ((t2 == null ? void 0 : t2.creationScope) ?? r).importNode(i3, true);
    E.currentNode = e2;
...
class M2 {
  ...
  constructor(t2, i3, s3, e2) {
    this.type = 2, this._$AH = T$1, this._$AN = void 0, this._$AA = t2, this._$AB = i3, this._$AM = s3, this.options = e2, this._$Cv = (e2 == null ? void 0 : e2.isConnected) ?? true;
  }
  get parentNode() {
    let t2 = this._$AA.parentNode;
    const i3 = this._$AM;
  ...
  $(t2) {
    ...
    if (((_a = this._$AH) == null ? void 0 : _a._$AD) === e2) this._$AH.p(i3);
    else {
  ...
  _$AR(t2 = this._$AA.nextSibling, i3) {
    var _a;
    for ((_a = this._$AP) == null ? void 0 : _a.call(this, false, true, i3); t2 && t2 !== this._$AB; ) {
      const i4 = t2.nextSibling;
      t2.remove(), t2 = i4;
    }
  }
...
class R2 {
  ...
  _$AI(t2, i3 = this, s3, e2) {
    ...
    if (void 0 === h2) t2 = N2(this, t2, i3, 0), o3 = !c$1(t2) || t2 !== this._$AH && t2 !== w, o3 && (this._$AH = t2);
      ...
      const e3 = t2;
      let n2, r2;
      for (t2 = h2[0], n2 = 0; n2 < h2.length - 1; n2++) r2 = N2(this, e3[s3 + n2], i3, n2), r2 === w && (r2 = this._$AH[n2]), o3 || (o3 = !c$1(r2) || r2 !== this._$AH[n2]), r2 === T$1 ? t2 = T$1 : t2 !== T$1 && (t2 += (r2 ?? "") + h2[n2 + 1]), this._$AH[n2] = r2;
    }
    o3 && !e2 && this.j(t2);
  }
  j(t2) {
...
class I extends R2 {
  ...
  _$AI(t2, i3 = this) {
    if ((t2 = N2(this, t2, i3, 0) ?? T$1) === w) return;
...
Z$1 == null ? void 0 : Z$1(V, M2), (t.litHtmlVersions ?? (t.litHtmlVersions = [])).push("3.1.4");
...
let T = class extends s$1 {
  ...
  render() {
    ...
    let o3 = "inverse";
    return this.variant === "ghost" && (o3 = "secondary"), this.variant === "outline" && (o3 = "accent"), x`<button class="${o$1(e2)}" ?disabled="${this.disabled}" @click="${this.onClick}">${this.iconLeft}<wcm-text variant="small-regular" color="${o3}"><slot></slot></wcm-text>${this.iconRight}</button>`;
  }
};
...
const nt = i$4`:host{display:inline-block}button{padding:0 15px 1px;height:40px;border-radius:var(--wcm-button-border-radius);color:var(--wcm-accent-fill-color);background-color:var(--wcm-accent-color)}button::after{content:'';top:0;bottom:0;left:0;right:0;position:absolute;background-color:transparent;border-radius:inherit;transition:background-color .2s ease;border:1px solid var(--wcm-color-overlay)}button:active::after{background-color:var(--wcm-color-overlay)}button:disabled{padding-bottom:0;background-color:var(--wcm-color-bg-3);color:var(--wcm-color-fg-3)}.wcm-secondary{color:var(--wcm-accent-color);background-color:transparent}.wcm-secondary::after{display:none}@media(hover:hover){button:hover::after{background-color:var(--wcm-color-overlay)}}`;
...
let ee = class extends s$1 {
  ...
  render() {
    ...
    return x`<button ?disabled="${this.disabled}" class="${o$1(e2)}"><slot></slot></button>`;
  }
};
...
const dt = i$4`:host{background-color:var(--wcm-color-bg-2);border-top:1px solid var(--wcm-color-bg-3)}div{padding:10px 20px;display:inherit;flex-direction:inherit;align-items:inherit;width:inherit;justify-content:inherit}`;
var wt = (e2, o3, r2, a2) => {
...
const bt = i$4`main{padding:20px;padding-top:0;width:100%}`;
var yt = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = i3(t2) || t2);
  return t2;
};
...
const $t = i$4`footer{padding:10px;display:flex;flex-direction:column;align-items:inherit;justify-content:inherit;border-top:1px solid var(--wcm-color-bg-2)}`;
var Ot = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = i3(t2) || t2);
  return t2;
};
...
let S2 = class extends s$1 {
  ...
  render() {
    const e2 = { "wcm-border": this.border }, o3 = T$3.state.history.length > 1, r2 = this.title ? x`<wcm-text variant="big-bold">${this.title}</wcm-text>` : x`<slot></slot>`;
    return x`<header class="${o$1(e2)}">${o3 ? this.backBtnTemplate() : null} ${r2} ${this.onAction ? this.actionBtnTemplate() : null}</header>`;
  }
};
...
const c = { MOBILE_BREAKPOINT: 600, WCM_RECENT_WALLET_DATA: "WCM_RECENT_WALLET_DATA", EXPLORER_WALLET_URL: "https://explorer.walletconnect.com/?type=wallet", getShadowRootElement(e2, o3) {
  ...
  const { walletImages: e2 } = y$2.state, o3 = Object.values(e2 ?? {});
...
} }, Mt = i$4`.wcm-router{overflow:hidden;will-change:transform}.wcm-content{display:flex;flex-direction:column}`;
...
const At = i$4`div{height:36px;width:max-content;display:flex;justify-content:center;align-items:center;padding:9px 15px 11px;position:absolute;top:12px;box-shadow:0 6px 14px -6px rgba(10,16,31,.3),0 10px 32px -4px rgba(10,16,31,.15);z-index:2;left:50%;transform:translateX(-50%);pointer-events:none;backdrop-filter:blur(20px) saturate(1.8);-webkit-backdrop-filter:blur(20px) saturate(1.8);border-radius:var(--wcm-notification-border-radius);border:1px solid var(--wcm-color-overlay);background-color:var(--wcm-color-overlay)}svg{margin-right:5px}@-moz-document url-prefix(){div{background-color:var(--wcm-color-bg-3)}}.wcm-success path{fill:var(--wcm-accent-color)}.wcm-error path{fill:var(--wcm-error-color)}`;
...
let ne = class extends s$1 {
  ...
  render() {
    ...
    return this.open ? x`<div class="${o$1(r2)}">${o3 === "success" ? v.CHECKMARK_ICON : null} ${o3 === "error" ? v.CROSS_ICON : null}<wcm-text variant="small-regular">${e2}</wcm-text></div>` : null;
  }
};
...
const Dt = { generate(e2, o3, r2) {
  ...
  $2.forEach(({ x: y2, y: u3 }) => {
    ...
    for (let M3 = 0; M3 < $2.length; M3 += 1) {
      const V2 = s3 * (A - M3 * 2);
      l2.push(b$1`<rect fill="${M3 % 2 === 0 ? a2 : t2}" height="${V2}" rx="${V2 * E2}" ry="${V2 * E2}" width="${V2}" x="${O + s3 * M3}" y="${b2 + s3 * M3}">`);
    }
  });
  ...
  return Se.forEach(([y2, u3]) => {
    ...
    u3.forEach((O) => {
      l2.push(b$1`<circle cx="${y2}" cy="${O}" fill="${a2}" r="${s3 / Ve}">`);
    });
    ...
    u3.forEach(([O, b2]) => {
      l2.push(b$1`<line x1="${y2}" x2="${y2}" y1="${O}" y2="${b2}" stroke="${a2}" stroke-width="${s3 / (Ve / 2)}" stroke-linecap="round">`);
    });
  }), l2;
...
let j = class extends s$1 {
  ...
  render() {
    ...
    return x`<div style="${`width: ${this.size}px`}" class="${o$1(e2)}">${this.walletId || this.imageUrl ? x`<wcm-wallet-image walletId="${l(this.walletId)}" imageId="${l(this.imageId)}" imageUrl="${l(this.imageUrl)}"></wcm-wallet-image>` : v.WALLET_CONNECT_ICON_COLORED} ${this.svgTemplate()}</div>`;
  }
};
...
const eo = i$4`:host{display:block}div{overflow:hidden;position:relative;border-radius:inherit;width:100%;height:100%;background-color:var(--wcm-color-overlay)}svg{position:relative;width:100%;height:100%}div::after{content:'';position:absolute;top:0;bottom:0;left:0;right:0;border-radius:inherit;border:1px solid var(--wcm-color-overlay)}div img{width:100%;height:100%;object-fit:cover;object-position:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}`;
...
let D = class extends s$1 {
  ...
  render() {
    ...
    return x`<div class="${o$1(e2)}">${this.svgLoaderTemplate()}<wcm-wallet-image walletId="${l(this.walletId)}" imageId="${l(this.imageId)}"></wcm-wallet-image></div><wcm-text variant="medium-regular" color="${this.isError ? "error" : "primary"}">${this.isError ? "Connection declined" : this.label}</wcm-text>`;
  }
};
...
const ko = i$4`div{display:grid;grid-template-columns:repeat(4,80px);margin:0 -10px;justify-content:space-between;row-gap:10px}`;
var Io = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = i3(t2) || t2);
  return t2;
};
let Le = class extends s$1 {
  ...
  render() {
    ...
    const $2 = Boolean(s3.length);
    return x`<wcm-modal-header title="Connect your wallet" .onAction="${this.onQrcode}" .actionIcon="${v.QRCODE_ICON}"></wcm-modal-header>${$2 ? x`<wcm-modal-content><div>${s3} ${i3 ? x`<wcm-view-all-wallets-button></wcm-view-all-wallets-button>` : null}</div></wcm-modal-content>` : null}`;
  }
};
Le.styles = [h.globalCss, ko], Le = Io([e$3("wcm-mobile-wallet-selection")], Le);
const Eo = i$4`:host{all:initial}.wcm-overlay{top:0;bottom:0;left:0;right:0;position:fixed;z-index:var(--wcm-z-index);overflow:hidden;display:flex;justify-content:center;align-items:center;opacity:0;pointer-events:none;background-color:var(--wcm-overlay-background-color);backdrop-filter:var(--wcm-overlay-backdrop-filter)}@media(max-height:720px) and (orientation:landscape){.wcm-overlay{overflow:scroll;align-items:flex-start;padding:20px 0}}.wcm-active{pointer-events:auto}.wcm-container{position:relative;max-width:360px;width:100%;outline:0;border-radius:var(--wcm-background-border-radius) var(--wcm-background-border-radius) var(--wcm-container-border-radius) var(--wcm-container-border-radius);border:1px solid var(--wcm-color-overlay);overflow:hidden}.wcm-card{width:100%;position:relative;border-radius:var(--wcm-container-border-radius);overflow:hidden;box-shadow:0 6px 14px -6px rgba(10,16,31,.12),0 10px 32px -4px rgba(10,16,31,.1),0 0 0 1px var(--wcm-color-overlay);background-color:var(--wcm-color-bg-1);color:var(--wcm-color-fg-1)}@media(max-width:600px){.wcm-container{max-width:440px;border-radius:var(--wcm-background-border-radius) var(--wcm-background-border-radius) 0 0}.wcm-card{border-radius:var(--wcm-container-border-radius) var(--wcm-container-border-radius) 0 0}.wcm-overlay{align-items:flex-end}}@media(max-width:440px){.wcm-container{border:0}}`;
...
let ae = class extends s$1 {
  ...
  render() {
    ...
    return x`<wcm-explorer-context></wcm-explorer-context><wcm-theme-context></wcm-theme-context><div id="wcm-modal" class="${o$1(e2)}" @click="${this.onCloseModal}" role="alertdialog" aria-modal="true"><div class="wcm-container" tabindex="0">${this.open ? x`<wcm-modal-backcard></wcm-modal-backcard><div class="wcm-card"><wcm-modal-router></wcm-modal-router><wcm-modal-toast></wcm-modal-toast></div>` : null}</div></div>`;
  }
};
ae.styles = [h.globalCss, Eo], Re([t$2()], ae.prototype, "open", 2), Re([t$2()], ae.prototype, "active", 2), ae = Re([e$3("wcm-modal")], ae);
const Ro = i$4`div{display:flex;margin-top:15px}slot{display:inline-block;margin:0 5px}wcm-button{margin:0 5px}`;
...
const To = i$4`button{display:flex;flex-direction:column;padding:5px 10px;border-radius:var(--wcm-button-hover-highlight-border-radius);height:100%;justify-content:flex-start}.wcm-icons{width:60px;height:60px;display:flex;flex-wrap:wrap;padding:7px;border-radius:var(--wcm-wallet-icon-border-radius);justify-content:space-between;align-items:center;margin-bottom:5px;background-color:var(--wcm-color-bg-2);box-shadow:inset 0 0 0 1px var(--wcm-color-overlay)}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}.wcm-icons img{width:21px;height:21px;object-fit:cover;object-position:center;border-radius:calc(var(--wcm-wallet-icon-border-radius)/ 2);border:1px solid var(--wcm-color-overlay)}.wcm-icons svg{width:21px;height:21px}.wcm-icons img:nth-child(1),.wcm-icons img:nth-child(2),.wcm-icons svg:nth-child(1),.wcm-icons svg:nth-child(2){margin-bottom:4px}wcm-text{width:100%;text-align:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}`;
var Do = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = i3(t2) || t2);
  return t2;
};
...
const No = i$4`.wcm-qr-container{width:100%;display:flex;justify-content:center;align-items:center;aspect-ratio:1/1}`;
...
const zo = i$4`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
...
const qo = i$4`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}wcm-button{margin-top:15px}`;
var Yo = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = i3(t2) || t2);
  return t2;
};
...
let he = class extends s$1 {
  ...
  render() {
    ...
    return x`<wcm-modal-header title="${e2}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${o3}" imageId="${l(r2)}" label="Tap 'Open' to continue…" .isError="${this.isError}"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer class="wcm-note"><wcm-platform-selection .isWeb="${l$12}" .isRetry="${true}"><wcm-button .onClick="${() => this.openMobileApp(false)}" .iconRight="${v.RETRY_ICON}">Retry</wcm-button></wcm-platform-selection>${s3 ? x`<wcm-text color="secondary" variant="small-thin">Still doesn't work? <span tabindex="0" @click="${() => this.openMobileApp(true)}">Try this alternate link</span></wcm-text>` : null}</wcm-info-footer><wcm-info-footer class="wcm-app-store"><div><wcm-wallet-image walletId="${o3}" imageId="${l(r2)}"></wcm-wallet-image><wcm-text>${`Get ${e2}`}</wcm-text></div><wcm-button .iconRight="${v.ARROW_RIGHT_ICON}" .onClick="${() => this.onGoToAppStore(i3)}" variant="ghost">App Store</wcm-button></wcm-info-footer>`;
  }
};
he.styles = [h.globalCss, Go], Ye([t$2()], he.prototype, "isError", 2), he = Ye([e$3("wcm-mobile-connecting-view")], he);
const er = i$4`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
var rr = (e2, o3, r2, a2) => {
  for (var t2 = o3, l2 = e2.length - 1, i3; l2 >= 0; l2--) (i3 = e2[l2]) && (t2 = i3(t2) || t2);
  return t2;
};
...
const nr = i$4`wcm-modal-content{height:clamp(200px,60vh,600px);display:block;overflow:scroll;scrollbar-width:none;position:relative;margin-top:1px}.wcm-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between;margin:-15px -10px;padding-top:20px}wcm-modal-content::after,wcm-modal-content::before{content:'';position:fixed;pointer-events:none;z-index:1;width:100%;height:20px;opacity:1}wcm-modal-content::before{box-shadow:0 -1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(var(--wcm-color-bg-1),rgba(255,255,255,0))}wcm-modal-content::after{box-shadow:0 1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(rgba(255,255,255,0),var(--wcm-color-bg-1));top:calc(100% - 20px)}wcm-modal-content::-webkit-scrollbar{display:none}.wcm-placeholder-block{display:flex;justify-content:center;align-items:center;height:100px;overflow:hidden}.wcm-empty,.wcm-loading{display:flex}.wcm-loading .wcm-placeholder-block{height:100%}.wcm-end-reached .wcm-placeholder-block{height:0;opacity:0}.wcm-empty .wcm-placeholder-block{opacity:1;height:100%}wcm-wallet-button{margin:calc((100% - 60px)/ 3) 0}`;
...
let U = class extends s$1 {
  ...
  render() {
    ...
    return x`<wcm-modal-header><wcm-search-input .onChange="${this.onSearchChange.bind(this)}"></wcm-search-input></wcm-modal-header><wcm-modal-content class="${o$1($2)}"><div class="wcm-grid">${a2 ? null : l2} ${a2 ? null : i3} ${a2 ? null : r2.map((f2) => x`${f2 ? x`<wcm-wallet-button imageId="${f2.image_id}" name="${f2.name}" walletId="${f2.id}" .onClick="${() => this.onConnect(f2)}"></wcm-wallet-button>` : null}`)}</div><div class="wcm-placeholder-block">${s3 ? x`<wcm-text variant="big-bold" color="secondary">No results found</wcm-text>` : null} ${!s3 && this.loading ? x`<wcm-spinner></wcm-spinner>` : null}</div></wcm-modal-content>`;
  }
};
...
const dr = i$4`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
